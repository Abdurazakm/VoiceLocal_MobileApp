...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // FIXED: Use cloudinary_public package for cross-platform uploads
  Future<void> _updateProfilePicture(String uid) async {
    ...
    try {
      // Use cloudinary_public package for reliable cross-platform uploads
      final response = await cloudinary.uploadFile(
        CloudinaryFile.fromFile(
          pickedFile.path,
          resourceType: CloudinaryResourceType.Image,
          folder: 'voicelocal_profiles',
        ),
      );
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () => _updateBio(uid, _bioController.text.trim()),
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                onPressed: () => _updateName(uid, _nameController.text.trim()),
                child: const Text("Save"),
              ),
            ),
            const SizedBox(height: 20),
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final user = UserModel.fromMap(userData, effectiveUid);
          ...
          return SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildSectionHeader(
                  "About Me",
                  isMe ? () => _showEditBioSheet(effectiveUid, user.bio) : null,
                ),
                ...
                const Divider(height: 40),
                _buildSectionHeader(
                  isMe ? "My Reports" : "${user.name}'s Reports",
                  null,
                ),
          ...
          children: [
            CircleAvatar(
              ...
              backgroundImage: user.profilePic.isNotEmpty
                  ...
                  : null,
              child: user.profilePic.isEmpty && !_isUploading
          ...
          children: [
            ...
            if (isMe)
              IconButton(
                ...
                onPressed: () => _showEditNameSheet(user.uid, user.name),
              ),
          ],
        ),
  ...
  Widget _buildBioBox(String bio) {
    return Container(
      ...
      child: Text(
        bio.isEmpty
            ? (isMe ? "Add a bio to introduce yourself!" : "No bio available.")
            : bio,
      ),
    );
  }
