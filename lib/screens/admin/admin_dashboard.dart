...
class AdminDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String? region =
        currentUser.assignedRegion; // Changed to match common field name
  ...
  void _showClearConfirmation(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "This will permanently delete all reported issues and their comments. This cannot be undone.",
        ),
        actions: [
          TextButton(
  ...
  Widget _buildNotificationBadge(BuildContext context) {
    Query notificationQuery = FirebaseFirestore.instance
    ...
    if (currentUser.assignedRegion != null) {
      notificationQuery = notificationQuery.where(
        'region',
        isEqualTo: currentUser.assignedRegion,
      );
    }
  ...
  Widget _buildProfileButton(BuildContext context, String uid) {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        String? url =
            (snapshot.data?.data() as Map<String, dynamic>?)?['profilePic'];
        return InkWell(
          onTap: () => Navigator.push(
            context,
